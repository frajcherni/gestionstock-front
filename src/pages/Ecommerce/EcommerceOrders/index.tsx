  ...
  const ArticlesList = () => {
      ...
      const fetchData = useCallback(async () => {
          try {
              setLoading(true);
              const [articlesData, categoriesData, fournisseursData] = await Promise.all([
                  fetchArticles(),
                  fetchCategories(),
                  fetchFournisseurs()
              ]);
      ...
      useEffect(() => {
          ...
          if (searchText) {
              ...
              result = result.filter(art =>
                  art.nom.toLowerCase().includes(searchLower) ||
                  ...
                  (art.fournisseur?.raison_sociale && art.fournisseur.raison_sociale.toLowerCase().includes(searchLower))
              );
          }
      ...
      const calculateTTC = (htValue: string | number, tvaRate: string | number, hasFodec: boolean) => {
  ...
  const handleSubmit = async (values: any) => {
      try {
        ...
        const articleData = {
          ...
          sous_categorie_id: values.sous_categorie_id ? Number(values.sous_categorie_id) : null,
        ...
        if (isEdit && article) {
          await updateArticle(article.id, articleData, selectedImage || undefined);
    ...
    const validation = useFormik({
      ...
      initialValues: {
        ...
        categorie_id: article?.sousCategorie ? String(article.sousCategorie.parent_id) : article?.categorie?.id ? String(article.categorie.id) : "",
        sous_categorie_id: article?.sousCategorie?.id ? String(article.sousCategorie.id) : "",
        pua_ht: article?.pua_ht || 0,
        puv_ht: article?.puv_ht || 0,
        pua_ttc: article?.pua_ttc || 0,
        puv_ttc: article?.puv_ttc || 0,
        fournisseur_id: article?.fournisseur?.id ? String(article.fournisseur.id) : "",
      ...
      validationSchema: Yup.object({
        ...
        pua_ht: Yup.number().required("Le prix d'achat HT est obligatoire").positive("Le prix doit être positif"),
        puv_ht: Yup.number().required("Le prix de vente HT est obligatoire").positive("Le prix doit être positif"),
  ...
  useEffect(() => {
      if (isEdit && article && modal) {
        ...
        const mainCategoryId = article.sousCategorie ? article.sousCategorie.parent_id : article.categorie?.id;
        if (mainCategoryId) {
          const subs = categories.filter(cat => cat.parent_id === mainCategoryId);
      ...
      useEffect(() => {
          if (validation.values.pua_ht !== undefined && validation.values.tva !== undefined) {
              ...
              const currentPuaTtc = parseFloat(validation.values.pua_ttc?.toString() || "0");
              const currentPuvTtc = parseFloat(validation.values.puv_ttc?.toString() || "0");
  
              // Only update if values are different to avoid infinite loop
              if (parseFloat(puaTtc) !== currentPuaTtc ||
  ...
  const columns = useMemo(
      () => [
          ...
          },
          {
              ...
              cell: (cell: any) => (
                  <Badge
                      color={cell.getValue()?.toLowerCase() === "consigné" ? "success" : "primary"}
  ...
  useEffect(() => {
      if (validation.values.categorie_id) {
        ...
        const currentSubId = validation.values.sous_categorie_id ? 
          parseInt(validation.values.sous_categorie_id.toString()) : null;
                      ...
                      <Col lg={12}>
                          <Card id="articleList">
                                  ...
                                  <Row className="align-items-center gy-3">
                                      ...
                                      <div className="col-sm-auto">
                                          <div className="d-flex gap-1 flex-wrap">
                                              ...
                                              >
                                                  <i className="ri-add-line align-bottom me-1"></i> Ajouter Article
                                              </button>
                                              <button
                                                  type="button"
                              ...
                              <CardBody className="pt-0">
                                      ...
                                      <Nav className="nav-tabs nav-tabs-custom nav-success" role="tablist">
                                          ...
                                          <NavItem>
                                              <NavLink
                                                  ...
                                                  href="#"
                                              >
                                                  <i className="ri-checkbox-circle-line me-1 align-bottom"></i> Consigné
                                              </NavLink>
                                          </NavItem>
                                          <NavItem>
                                              <NavLink
                                                  ...
                                                  href="#"
                                              >
                                                  <i className="ri-close-circle-line me-1 align-bottom"></i> Non Consigné
                                              </NavLink>
                                          </NavItem>
                                      </Nav>
                                  ...
                                  {/* Details Modal */}
                                  <Modal isOpen={detailsModal} toggle={toggleDetailsModal} centered size="lg">
                                      ...
                                      <ModalBody>
                                          {article && (
                                              <Row>
                                                  ...
                                                  <Col md={6}>
                                                      <div className="mb-3">
                                                          <Label className="form-label fw-semibold">Famille</Label>
                                                  ...
                                                  <Col md={6}>
                                                      <div className="mb-3">
                                                          ...
                                                          <p>{article.fournisseur?.raison_sociale || "N/A"}</p>
                                                      </div>
                                                  </Col>
  
                                                  <Col md={6}>
                                                      <div className="mb-3">
                                                          <Label className="form-label fw-semibold">Prix d'achat HT</Label>
                                                          <p>{article.pua_ht ? Number(article.pua_ht).toFixed(2) : "0.00"} TND</p>
                                                      </div>
                                                  </Col>
  
                                                  <Col md={6}>
                                                      <div className="mb-3">
                                                          <Label className="form-label fw-semibold">Prix d'achat TTC</Label>
                                                          <p>{article.pua_ttc ? Number(article.pua_ttc).toFixed(2) : "0.00"} TND</p>
                                                      </div>
                                                  </Col>
  
                                                  <Col md={6}>
                                                      <div className="mb-3">
                                                          <Label className="form-label fw-semibold">Prix de vente HT</Label>
                                                          <p>{article.puv_ht ? Number(article.puv_ht).toFixed(2) : "0.00"} TND</p>
                                                      </div>
                                                  </Col>
                                                  ...
                                                  <Col md={6}>
                                                      <div className="mb-3">
                                                          ...
                                                          <p>{article.puv_ttc ? Number(article.puv_ttc).toFixed(2) : "0.00"} TND</p>
                                                      </div>
                                                  </Col>
                                                  ...
                                                  <Col md={6}>
                                                      <div className="mb-3">
                                                          <Label className="form-label fw-semibold">FODEC</Label>
                                                          <p>
                                                              <Badge color={article.taux_fodec ? "success" : "secondary"}>
                                                  ...
                                                  <Col md={6}>
                                                      <div className="mb-3">
                                                          ...
                                                          <p>
                                                              <Badge
                                                                  color={article.type?.toLowerCase() === "consigné" ? "success" : "primary"}
                                                                  className="text-uppercase"
                                                              >
                                                                  {article.type}
                                                              </Badge>
                                                  ...
                                                  <Col md={6}>
                                                      <div className="mb-3">
                                                          ...
                                                          <p>{moment(article.createdAt).format("DD MMM YYYY")}</p>
                                                      </div>
                                                  </Col>
                                              </Row>
                      ...
                      <div className="mb-3">
                          ...
                          <div className="border rounded p-3 text-center">
                              {imagePreview || article?.image ? (
                                  <div className="mb-3">
                                      <img 
                                           src={imagePreview || (article?.image ? `http://54.37.159.225:5000/${article.image.replace(/\\/g, "/")}` : "")}
                  ...
                  <Col md={6}>
                      <div className="mb-3">
                          ...
                          <Input
                              ...
                              invalid={validation.touched.reference && !!validation.errors.reference}
                          />
  
                          <FormFeedback>{validation.errors.reference}</FormFeedback>
                      </div>
                  </Col>
                  <Col md={6}>
                      <div className="mb-3">
                  ...
                  <Col md={6}>
                      <div className="mb-3">
                          ...
                          <Input
                              ...
                              invalid={validation.touched.categorie_id && !!validation.errors.categorie_id}
                          >
                  ...
                  <Col md={6}>
                      <div className="mb-3">
                          ...
                          <Input
                              ...
                              invalid={validation.touched.fournisseur_id && !!validation.errors.fournisseur_id}
                          >
                          ...
                          <FormFeedback>{validation.errors.fournisseur_id}</FormFeedback>
                      </div>
                  </Col>
                  <Col md={6}>
                      <div className="mb-3">
                  ...
                  <Col md={6}>
                      <div className="mb-3">
                          ...
                          <Input
                              ...
                              className="bg-light"
                          />
                          <small className="text-muted">Calculé: HT + TVA + FODEC</small>
                      </div>
                  </Col>
                  <Col md={6}>
                      <div className="mb-3">
                      ...
                      <div className="mb-3 d-flex align-items-end" style={{ height: "100%" }}>
                          <div className="form-check form-switch">
                              <Input
                                  ...
                                  id="fodecSwitch"
                              />
                              <Label className="form-check-label" for="fodecSwitch">
                                  Taux FODEC (1%)
                              </Label>
                          </div>
                      </div>
